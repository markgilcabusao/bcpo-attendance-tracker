 ...
 */
export const convertToPHT = (date) => {
 ...
 */
export const formatTimeInPHT = (date) => {
 ...
 */
export const formatTimeInPHT12Hour = (date) => {
    // Don't call convertToPHT here - the date is already in PHT
 ...
 */
export const formatDateInPHT = (date) => {
 ...
 */
export const formatISOInPHT = (date) => {
    const phtDate = convertToPHT(date);
    const year = phtDate.getFullYear();
    const month = String(phtDate.getMonth() + 1).padStart(2, '0');
    const day = String(phtDate.getDate()).padStart(2, '0');
 ...
 */
export const createTimeInPHT = (timeString, baseDate) => {
 ...
 */
export const createDateInPHT = (dateString) => {
 ...
 */
export const getTomorrowAtTimeInPHT = (timeString) => {
 ...
 */
export const isTodayInPHT = (date) => {
 ...
 */
export const parseTimeToPHT = (timeStr, baseDate) => {
    if (!timeStr)
        return null;
 ...
 */
export const formatDatabaseTimeToPHT = (timeStr) => {
    if (!timeStr)
        return '';
 ...
 */
export const getPHTOffsetString = () => {
    return '+08:00';
};
/**
 * Convert a UTC ISO string to PHT Date
 */
export const utcISOToPHT = (utcISO) => {
