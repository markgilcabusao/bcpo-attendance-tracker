...
export function useCalendarState() {
    ...
    // ============================================================================
    const saveToLocalBackup = useCallback((state) => {
        try {
    ...
    const loadFromSupabase = useCallback(async () => {
        ...
        try {
            ...
            if (data?.preference_value && isMountedRef.current) {
                const state = data.preference_value;
